...
<div>
	...
	<div class="mt-4 mb-4 flex">
		<div class="self-center">
			<a href="/{language}/profile?id={news.expand.author.id}">By {news.expand.author.username}</a>
		</div>
		{#if news.expand.author.avatar != ''}
			<div class="mr-2 ml-2">
				<a href="/{language}/profile?id={news.expand.author.id}">
					<img
	...
	{#if showCommentsLine}
		<div class="mt-4 flex gap-4 place-self-center">
			<a href="/{language}/news/{news.id}" class="text-lg font-semibold text-blue-300"
