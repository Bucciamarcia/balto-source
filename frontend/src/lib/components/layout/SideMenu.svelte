...
<div class="p-10">
	...
	<div>
		<img src={baltoSectionImage} alt="Balto 1 section" />
		<ul>
			<li>Multimedia</li>
			<li>Articles</li>
			<li>The True Story</li>
			<li>Information</li>
			<li>Reviews</li>
			<li>Merchandise</li>
			<li>Production</li>
	...
	<div>
		<h2><strong>Balto 2: Wolf Quest</strong></h2>
	...
	<br />
	<div>
		<h2><strong>Balto 3: Wings of Change</strong></h2>
	...
	<div>
		<h2><strong>Selection Of The Week</strong></h2>
		<br />
